...
var _ChallengeFactory = __webpack_require__(21);

var _ChallengeFactory2 = _interopRequireDefault(_ChallengeFactory);
...
var OWNER = 'owner';
var APPLICATION_EXPIRY = 'applicationExpiry';
var WHITELISTED = 'whitelisted';
var UNSTAKED_DEPOSIT = 'unstakedDeposit';
var CHALLENGE_ID = 'challengeID';

var Listing = function (_Component) {
  _inherits(Listing, _Component);

  function Listing(name, rawDataFromContract, provider, contract) {
    _classCallCheck(this, Listing);

    var _this = _possibleConstructorReturn(this, (Listing.__proto__ || Object.getPrototypeOf(Listing)).call(this, provider));

    _this.name = name;
    _this._rawData = rawDataFromContract;
    _this.contract = contract;
    _this._challengeFactory = new _ChallengeFactory2.default(provider, contract);
    return _this;
  }
  ...
  _createClass(Listing, [{
    ...
    value: function getOwner() {
      return this._property(OWNER) === (0, _utils.stubAddress)() ? null : this._property(OWNER);
    }
  }, {
    key: 'isWhitelisted',
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                return _context.abrupt('return', this._challengeFactory.create(challengeId));
    ...
    key: '_property',
    value: function _property(propName) {
...
var _ListingFactory = __webpack_require__(16);

var _ListingFactory2 = _interopRequireDefault(_ListingFactory);
...
var Registry = function (_Component) {
  ...
  function Registry(address, provider) {
    ...
    _this._listingFactory = new _ListingFactory2.default(provider, _this.contract);
    return _this;
  }
  ...
  _createClass(Registry, [{
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this._listingFactory.create(name);
    ...
    key: 'getAccount',
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(owner) {
        var tokenAddress;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                return _context4.abrupt('return', new _Account2.default(owner, tokenAddress, this.provider));
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                parameterizerAddress = _context5.sent;
                return _context5.abrupt('return', new _Parameterizer2.default(parameterizerAddress, this.provider));
...
var ListingFactory = function () {
  function ListingFactory(provider, contract) {
    _classCallCheck(this, ListingFactory);

    this.provider = provider;
    this.contract = contract;
  }

  _createClass(ListingFactory, [{
    key: 'create',
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.contract.methods.listings(_Listing2.default.hashName(this.name)).call();

              case 2:
                listingRawData = _context.sent;
                _context.next = 5;
                return this.contract.methods.appWasMade(this.name).call();

              case 5:
                listingRawData['exists'] = _context.sent;
                return _context.abrupt('return', new _Listing2.default(name, listingRawData, this.provider, this.contract));
...
exports.default = ListingFactory;
module.exports = exports['default'];
...
var _Challenge = __webpack_require__(22);
...
var ChallengeFactory = function () {
  function ChallengeFactory(provider, contract) {
  ...
  _createClass(ChallengeFactory, [{
    key: 'create',
    value: function create(challengeId) {
      return new _Challenge2.default(challengeId, {}, this.provider, this.contract);
    }
  }]);
...
exports.default = ChallengeFactory;
module.exports = exports['default'];
...
var Challenge = function (_Component) {
  ...
  function Challenge(id, rawDataFromContract, provider, contract) {
    _classCallCheck(this, Challenge);

    var _this = _possibleConstructorReturn(this, (Challenge.__proto__ || Object.getPrototypeOf(Challenge)).call(this, provider));
