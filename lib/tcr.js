...
function contract(name, address, provider) {
  var abi = __webpack_require__(6)("./" + name + '.json');
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 2:
                ...
                return _context9.abrupt('return', new _Challenge2.default(challengeId, this.registry));
...
var _PLCRVoting = __webpack_require__(23);
...
var map = {
	"./AttributeStore.json": 7,
	"./Challenge.json": 8,
	"./DLL.json": 9,
	"./PLCRVoting.json": 10,
	"./Parameterizer.json": 11,
	"./Registry.json": 12,
	"./StandardToken.json": 13
};
...
var _Parameterizer = __webpack_require__(15);
...
var _Poll = __webpack_require__(24);
